...
export type MonsterClassFilter = "all" | "normal" | "effect" | "fusion" | "ritual";
...
export function deckComposition(
  counts: Record<string, number>,
  cardsById: Map<string, Card>,
): { monsters: number; normalMonsters: number; effectMonsters: number; ritualMonsters: number; spells: number; traps: number };
